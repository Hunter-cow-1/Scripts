...
白嫖的项目：签到白嫖游戏服务器或者稳定的虚拟主机，攒着提现也可以（2018年以来一直稳定运行的，自己可以查一查资料）
 ...
 第二步：去  https://www.rainyun.cc/?ref=MzY0NDk=_ 注册一个账号（不提现只抢游戏云和主机的话不用实名）
 想提现的话6万积分起提现...绑定支付宝提现（稳到，亲测过，也有官方用户群）。
 第三步：本脚本里第156行157行里设置一下自己注册的账号和密码！！！
         本脚本里第156行157行里设置一下自己注册的账号和密码！！！
         本脚本里第156行157行里设置一下自己注册的账号和密码！！！
...
注册地址：
https://www.rainyun.cc/?ref=MzY0NDk=_
